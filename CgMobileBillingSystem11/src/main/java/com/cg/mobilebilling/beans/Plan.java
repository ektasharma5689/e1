...
public class Plan {
	...
	private int freeLocalCalls;
	private int freeStdCalls;
	private int freeLocalSMS;
	private int freeStdSMS;
	private int freeInternetDataUsageUnits;
	private float localCallRate;
	private float stdCallRate;
	private float localSMSRate;
	private float stdSMSRate;
	private float internetDataUsageRate;
